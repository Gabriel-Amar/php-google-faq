<?php
    $domande = [
        [
            "titolo" => "<h1>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h1>",
            "testo" => 
        ...
        [
            "titolo" => "<h1>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h1>",
        ...
        [
            "titolo" => "<h1>Perché il mio account è associato a un paese?</h1>",
        ...
        [
            "titolo" => "<h1>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h1>",
        ...
        [
            "titolo" => "<h1>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?</h1>",
    ...
    <div class="container-fluid">
        <nav class="navbar">
            <div class="container-fluid">
                ...
                <img src="img/google-1018443_960_720.webp" alt="" width="70" height="30" class="d-inline-block align-text-top">
                Privacy e termini
                <form class="d-flex">
                    <svg>
