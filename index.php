<?php
    $domande = [
        [
            "titolo" => "<h3>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h3>",
            "testo" => 
        ...
        [
            "titolo" => "<h3>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h3>",
        ...
        [
            "titolo" => "<h3>Perché il mio account è associato a un paese?</h3>",
        ...
        [
            "titolo" => "<h3>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h3>",
        ...
        [
            "titolo" => "<h3>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?</h3>",
...
<body>
        ...
        <nav class="navbar fixed-top navbar-light" style="background-color: #ffffff;">
            <div class="container-fluid">
                <div class="d-flex">
                    ...
                    <img src="img/google-1018443_960_720.webp" alt="" width="85" height="30" class="d-inline-block align-text-top">
                    Privacy e termini
                </div>
    ...
    <ul>
        <?php for ($i = 0; $i < count($domande); $i++) { ?>
            <li>
                <?php echo "{$domande[$i]['titolo']}"; ?>
                <?php echo "{$domande[$i]['testo']}"; ?>
            </li>
        <?php } ?>
    </ul>
    </div>
